...
# the two explanatories (or the fish), so the addition of bullheads to the tanks did not result in greater impact on midge density.
...
# using 2 standard error [at 95% or p=0.05 level]. Note: errors don't overlap for Bullhead
