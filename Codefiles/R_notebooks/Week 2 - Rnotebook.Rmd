...
We strongly recommend that you use the names, str, head, tail and dim functions after import. You need to be sure you've got the correct dataset!!
...
### Base R
1. Use the deep sea research data (ISIT.txt). Load it in using read.table. The file contains bioluminscence data oo organisms from various depths and locations in the North Sea. 
...
Repeat each one using tidyverse packages.
