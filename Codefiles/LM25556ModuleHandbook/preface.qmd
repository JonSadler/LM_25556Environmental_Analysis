...
The class materials are written as a [Quarto](https://quarto.org/) book which is renders to a sequence of link html files (and a PDF document). You need to click on the ‘index.html’ file to use it as a book - this will open up the list of chapters.
