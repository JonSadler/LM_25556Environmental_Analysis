...
This week we are going to make a start on data visualisation and exploration. To do this we will use graphical techniques that visualize and transform to explore data in a systematic way, a task that statisticians call **exploratory data analysis**, or EDA for short. @Zuur2010 provides an excellent outline of EDA strategies. Please read the paper!
