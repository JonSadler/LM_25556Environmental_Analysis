...
# *************************************************************************
# Jon Sadler Sept 2013 updated Jan 2021 [updated April 2024]
...
#They have special properties and are the general means of housing data in R (after import). 
...
# Loading in datafiles using read.table (for tab delineated data) ----
