...
# *************************************************************************
# Jon Sadler Jan 2014 updated Jan 2021 [updated April 2024]
...
# ******************************************************
# PART 2: Transforming data - Summarising, aggregating, filtering, mutating ----
# ******************************************************
...
filter(Veg, Transect %in% 1:2) # displays all the records in transects 1 and 2
...
VegT12 <- filter(Veg, Transect %in% 1:2) # displays all the records in transects 1 and 2
...
df <- read.csv("raptor_survey.csv",header=TRUE) # raptor_survey.csv 
temps <- read.csv("raptor_temps.csv",header=TRUE) # raptor_temps.csv
siteinfo <- read.csv("raptor_sites.csv",header=TRUE) # raptor_sites.csv
