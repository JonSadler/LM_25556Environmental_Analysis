...
gotelli <- read.csv("~/Documents/GitHub/Teaching/LM_25556Environmental_Analysis/Data/gotelli.csv")
...
# in ggplot
ggplot(gotelli.glm,aes(x=Latitude, y = Srich)) + 
  geom_point() + geom_smooth()+
  facet_wrap(~Habitat)

ggplot(gotelli,aes(x=Latitude, y = Srich, col=Habitat)) + 
  geom_point()+
  geom_smooth()
...
Road <- read.csv("~/Documents/GitHub/Teaching/LM_25556Environmental_Analysis/Data/RoadKills.csv")
 # Plot......
...
spider <- read.csv("~/Documents/GitHub/Teaching/LM_25556Environmental_Analysis/Data/polis.csv")
...
# It's okay but slight under dispersed. If it were near <0.8 we'd need to deal with that.
...
# filename is bolger.csv
# explanatories - area of canyon fragment, % cover of shrub, distance to nearest canyon
# Import the data
bolger <- read.csv("~/Documents/GitHub/Teaching/LM_25556Environmental_Analysis/Data/bolger.csv")
str(bolger)
head(bolger)
