...
# Load the data
Veg <- read.csv("~/Documents/GitHub/Teaching/LM_25556Environmental_Analysis/Data/vegetation2.csv")
# Look at it
...
# If you ever have the need to use GAMs extensively in your research then 
# check out the blog 'from the bottom of the heap' by Gavin Simpson. Or search
# for his Youtube tutorials which are listed un the same blog name I think.
